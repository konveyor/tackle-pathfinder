...
echo
echo '1 >>> Obtaining the keycloak token for the operations'
access_token=$(curl --http1.0 -X -o POST "http://$keycloak_ip/auth/realms/quarkus/protocol/openid-connect/token" \
